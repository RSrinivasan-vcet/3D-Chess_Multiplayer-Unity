...
public class BoardManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        NetworkManager.Instance.SetWhitePlayerTurn(isWhiteTurn);
    }
    ...
    private void UpdateSelection()
    {
        ...
        {
            isWhiteTurn = NetworkManager.Instance.GetWhitePlayerTrun();
    ...
    private void SpawnChessman(int index, int x, int y, bool isWhite)
    {
        ...
        if (isWhite)
        {
            go = PhotonNetwork.Instantiate(chessmanPrefabs[index].name, position, whiteOrientation) as GameObject;
        }
        else
        {
            go = PhotonNetwork.Instantiate(chessmanPrefabs[index].name, position, blackOrientation) as GameObject;
